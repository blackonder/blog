 <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>TeknoMetot</b> Blog</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="#">Bütün mesajları gör</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">10 tane bildirimin var</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                  <li>
                  ...
                  <li>
                    <a href="#">
                      <i class="fa fa-users text-red"></i> 5 yeni üye katıldı
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-shopping-cart text-green"></i> 25 satış yapıldı
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-user text-red"></i> Kullanıcı adını değiştirdin
                    </a>
                  </li>
                </ul>
              </li>
          ...
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">9 görevin var</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                  <li><!-- Task item -->
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Önder</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  Önder - Computer Eng.
                  <small>August 2021'den beri üye</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
